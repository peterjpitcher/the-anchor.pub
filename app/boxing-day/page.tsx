...
export default function BoxingDayPage() {
  return (
    <>
          ...
          <div className="mx-auto max-w-4xl space-y-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-ink-muted leading-relaxed">
                ...
                <span className="font-semibold text-ink">1pm&ndash;7pm</span>. We serve our regular Saturday
            ...
            <Card accent>
              <CardBody className="space-y-4">
                <h2 className="text-h4 text-ink-strong">Book Your Table</h2>
                <p className="text-ink-muted leading-relaxed">
      ...
      <CtaBand
        title="Escape the house this Boxing Day"
        copy="Saturday 26 December 2026. A walk, a pint, and proper pub food at The Anchor in Stanwell Moor. Kitchen open 1pm to 7pm. Free parking. Dogs welcome."
        primary={
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Card>
                <CardBody className="space-y-2">
                  <h3 className="text-lg font-semibold text-ink-strong">The Boxing Day walk</h3>
                  <p className="text-sm text-ink-muted">
