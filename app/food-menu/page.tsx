        ...
        <Container>
          ...
          <div className="flex justify-center mb-8">
            <a
              ...
              download
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-anchor-gold/10 border border-anchor-gold/30 rounded-lg text-anchor-gold hover:bg-anchor-gold/20 transition-colors text-sm font-medium"
            >
