  ...
  if (!events.length) {
    return (
      <div className="rounded-xl border border-gray-200 bg-white p-6 text-center">
        <p className="mb-2 text-lg font-semibold text-anchor-green">New Music Bingo dates are loading soon</p>
  ...
  return (
    <>
      ...
      <Section spacing="md" background="gray">
        <Container>
          <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-2 md:items-stretch">
            ...
            <Card className="border border-amber-100 bg-anchor-cream shadow-sm">
              <CardBody className="space-y-4">
                <h3 className="text-2xl font-bold text-anchor-charcoal">How Music Bingo runs</h3>
      ...
      <Section spacing="md" background="white" id="music-bingo-dates">
        <Container>
          <div className="mx-auto max-w-5xl">
            <h2 className="mb-6 text-center text-3xl font-bold text-anchor-charcoal">Upcoming Music Bingo dates</h2>
        ...
        <Container>
          <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-3">
            <Card className="bg-anchor-cream/50 shadow-sm">
              <CardBody>
                <h3 className="mb-2 text-xl font-semibold text-anchor-green">Sunday Roast Music Bingo Warm-Up</h3>
            ...
            <Card className="bg-white shadow-sm">
              <CardBody>
                <h3 className="mb-2 text-xl font-semibold text-anchor-green">Stone-Baked Pizza Warm-Up</h3>
                <p className="mb-4 text-sm text-gray-700">
            ...
            <Card className="bg-anchor-cream/50 shadow-sm">
              <CardBody>
                <h3 className="mb-2 text-xl font-semibold text-anchor-green">All-Day Menu and Cocktails</h3>
                <p className="mb-4 text-sm text-gray-700">
      ...
      <Section spacing="md" background="white">
        <Container>
          <div className="mx-auto max-w-6xl">
            <h2 className="mb-8 text-center text-3xl font-bold text-anchor-charcoal md:text-4xl">
              Why everyone loves Music Bingo at The Anchor
            </h2>
            <Grid cols={WHY_LOVE_IT.length > 3 ? 3 : 2} gap="md">
              {WHY_LOVE_IT.map(feature => (
                <GridItem key={feature.title}>
                  <Card className="h-full border border-gray-100 bg-white shadow-sm transition hover:shadow-md">
        ...
        <Container>
          <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-2 md:items-start">
            <Card className="border border-gray-200 bg-white shadow-sm">
              <CardBody className="space-y-4">
                <h3 className="text-2xl font-bold text-anchor-charcoal">How to play Music Bingo</h3>
      ...
      <Section spacing="md" background="white">
        <Container>
          <div className="mx-auto max-w-5xl">
            <h2 className="mb-6 text-center text-3xl font-bold text-anchor-charcoal">Tips for a winning card</h2>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="h-full border border-gray-100 bg-white shadow-sm">
                <CardBody className="space-y-3">
                  <h3 className="text-xl font-semibold text-anchor-charcoal">Bring a mixed crew</h3>
              ...
              <Card className="h-full border border-gray-100 bg-white shadow-sm">
                <CardBody className="space-y-3">
                  <h3 className="text-xl font-semibold text-anchor-charcoal">Arrive early</h3>
                  <p className="text-sm leading-relaxed text-gray-700">
              ...
              <Card className="h-full border border-gray-100 bg-white shadow-sm">
                <CardBody className="space-y-3">
                  <h3 className="text-xl font-semibold text-anchor-charcoal">Keep your card visible</h3>
                  <p className="text-sm leading-relaxed text-gray-700">
              ...
              <Card className="h-full border border-gray-100 bg-white shadow-sm">
                <CardBody className="space-y-3">
                  <h3 className="text-xl font-semibold text-anchor-charcoal">Stay for the finale</h3>
                  <p className="text-sm leading-relaxed text-gray-700">
      ...
      <Section spacing="md" background="gray">
        <Container>
          <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-2 md:items-start">
            <div>
              <h2 className="mb-3 text-2xl font-bold text-anchor-charcoal">Find us</h2>
            ...
            <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
              <GoogleMapEmbed
                ...
                className="h-full min-h-[300px] overflow-hidden rounded-xl border border-gray-200 shadow-sm"
              />
            </div>
          </div>
        </Container>
