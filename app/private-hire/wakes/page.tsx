                ...
                <Container>
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        {[
                            ...
                            { title: "Accessibility for All Guests", description: "The venue is entirely on the ground floor, making it easy for elderly guests and those with mobility difficulties. Accessible toilets are available on site, and our car park is directly adjacent to the entrance with no steps to navigate." },
