...
export async function NextEventServer() {
  try {
    ...
    return (
      <div className="max-w-6xl mx-auto min-w-0 space-y-4">
        <div className="card-dark min-w-0">
          ...
          <div className="grid min-w-0 gap-0 lg:grid-cols-[minmax(0,340px)_minmax(0,1fr)]">
            ...
            <div className="flex min-w-0 flex-col gap-4 p-4 sm:p-5 lg:p-6">
              <div className="flex min-w-0 flex-wrap items-center gap-2 text-xs font-semibold uppercase tracking-wide">
                ...
                {nextEvent.category && (
                  <span
                    className="inline-flex min-w-0 items-center gap-2 rounded-full px-3 py-1"
                    style={{
                ...
                {urgency && (
                  <span className={`inline-flex min-w-0 items-center rounded-full px-3 py-1 shadow-sm ${urgency.badgeClassName}`}>
                    {urgency.label}
                  </span>
                )}
              </div>
              ...
              {urgency && (
                <div className={`min-w-0 p-3 text-sm leading-relaxed ${urgency.panelClassName}`}>
              ...
              {nextEvent.description && (
                <p className="min-w-0 break-words text-sm text-anchor-cream-text/70 leading-relaxed">
                  {nextEvent.description}
                </p>
              )}
              ...
              return (
                <div key={event.id} className="card-dark min-w-0">
                  ...
                  <div className="grid min-w-0 gap-4 p-4 sm:grid-cols-[160px_1fr]">
                    ...
                    <div className="min-w-0">
                      <p className="break-words text-xs font-semibold uppercase tracking-[0.18em] text-anchor-cream-text/50">
                      ...
                      <p className="mt-1 break-words text-sm text-anchor-cream-text/70 line-clamp-2">
