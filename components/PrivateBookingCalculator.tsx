...
export function PrivateBookingCalculator({ eventType, compact = false, quoteStartedOnMount = false }: PrivateBookingCalculatorProps) {
    ...
    return (
        <div className="card-dark rounded-none overflow-hidden font-sans">
            ...
            {compact ? (
                promoActive && (
                    <div className="p-4 bg-anchor-bg-raised border-b border-anchor-gold/15">
                        <div className="border border-anchor-gold/40 bg-anchor-bg-card p-3">
                            <p className="text-xs font-bold text-anchor-gold-vivid flex items-center gap-2 mb-0.5">
                ...
                <div className="p-8 bg-anchor-bg-raised border-b border-anchor-gold/15 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-3xl font-serif font-bold text-anchor-cream-text mb-1">Event Cost Estimator</h3>
                        ...
                        {promoActive && (
                            <div className="mt-6 p-5 border border-anchor-gold/40 bg-anchor-bg-card relative overflow-hidden group transition-shadow">
            ...
            <div className={cn(compact ? 'p-4 space-y-6' : 'p-8 space-y-12', 'bg-anchor-bg-card')}>
                {/* Step 1: Event Date */}
                <section>
                    <div className={cn('flex items-center gap-2', compact ? 'mb-3' : 'mb-6')}>
                        <span className={cn(compact ? 'w-5 h-5 text-[10px]' : 'w-7 h-7 text-xs', 'flex items-center justify-center border border-anchor-gold/50 text-anchor-gold-vivid font-bold')}>1</span>
                        <h4 className={cn(compact ? 'text-sm' : 'font-serif text-xl', 'font-bold text-anchor-cream-text')}>When is your event?</h4>
                    </div>
                ...
                <section>
                    <div className={cn('flex items-center gap-2', compact ? 'mb-3' : 'mb-6')}>
                        <span className={cn(compact ? 'w-5 h-5 text-[10px]' : 'w-7 h-7 text-xs', 'flex items-center justify-center border border-anchor-gold/50 text-anchor-gold-vivid font-bold')}>2</span>
                        <h4 className={cn(compact ? 'text-sm' : 'font-serif text-xl', 'font-bold text-anchor-cream-text')}>Choose Event Type</h4>
                    </div>
                ...
                <section>
                    <div className={cn('flex items-center gap-2', compact ? 'mb-3' : 'mb-6')}>
                        <span className={cn(compact ? 'w-5 h-5 text-[10px]' : 'w-7 h-7 text-xs', 'flex items-center justify-center border border-anchor-gold/50 text-anchor-gold-vivid font-bold')}>3</span>
                        <h4 className={cn(compact ? 'text-sm' : 'font-serif text-xl', 'font-bold text-anchor-cream-text')}>Choose a Space</h4>
                        <a href="/our-pub" className={cn(compact ? 'text-xs' : 'text-sm', 'ml-auto text-anchor-gold font-semibold hover:text-anchor-gold-vivid hover:underline')}>
                            See photos &rarr;
                        </a>
                    </div>
                            ...
                            >
                                <div className={cn(compact ? 'flex items-center gap-2 flex-1 min-w-0' : 'flex justify-between items-start mb-4')}>
                                    <span className={cn(
                                        ...
                                        compact ? 'text-sm' : 'font-serif text-xl',
                                        selectedSpaceId === space.id ? 'text-anchor-gold-vivid' : 'text-anchor-cream-text group-hover:text-anchor-gold-vivid'
                                    )}>
                                        {space.name}
                                    </span>
                                    {selectedSpaceId === space.id && (
                                        <div className="text-anchor-gold-vivid flex-shrink-0">
                                ...
                                {compact ? (
                                    <div className="flex items-center gap-3 flex-shrink-0">
                                        <span className="text-sm font-bold text-anchor-gold">{formatCurrency(space.rate_per_hour)}<span className="text-anchor-cream-text/40 font-normal text-xs">/hr</span></span>
                ...
                {/* Event Details */}
                <section className={cn(compact ? 'bg-anchor-bg-raised p-4 border border-anchor-gold/15' : 'bg-anchor-bg-raised p-8 border border-anchor-gold/15')}>
                    <div className={cn('flex items-center gap-2', compact ? 'mb-3' : 'mb-6')}>
                        <span className={cn(compact ? 'w-5 h-5 text-[10px]' : 'w-7 h-7 text-xs', 'flex items-center justify-center border border-anchor-gold/50 text-anchor-gold-vivid font-bold')}>4</span>
                        <h4 className={cn(compact ? 'text-sm' : 'font-serif text-xl', 'font-bold text-anchor-cream-text')}>Event Details</h4>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                <input
                                    ...
                                    className={cn(
                                        'w-full bg-anchor-bg-card border border-anchor-gold/30 rounded-none focus:ring-2 focus:ring-anchor-gold focus:border-anchor-gold transition-all font-bold text-anchor-cream-text group-hover:border-anchor-gold/50',
                ...
                <section>
                    <div className={cn('flex flex-col sm:flex-row sm:items-end justify-between gap-3', compact ? 'mb-3' : 'mb-6 gap-4')}>
                        <div className="flex items-center gap-2">
                            <span className={cn(compact ? 'w-5 h-5 text-[10px]' : 'w-7 h-7 text-xs', 'flex items-center justify-center border border-anchor-gold/50 text-anchor-gold-vivid font-bold')}>5</span>
                            <div>
                                <h4 className={cn(compact ? 'text-sm' : 'font-serif text-xl', 'font-bold text-anchor-cream-text')}>Catering & Drinks</h4>
                        ...
                        <button
                            ...
                            className={cn(
                                'bg-anchor-bg-raised border border-dashed border-anchor-gold/40 text-anchor-gold-vivid font-bold rounded-none hover:bg-anchor-gold-vivid hover:text-anchor-bg hover:border-anchor-gold-vivid transition-all flex items-center justify-center gap-1.5',
                    ...
                    <div className={cn(compact ? 'space-y-2' : 'space-y-4')}>
                        {selectedPackages.length === 0 && (
                            <div className={cn('text-center bg-anchor-bg-raised border border-dashed border-anchor-gold/25', compact ? 'py-4' : 'py-10')}>
                                {!compact && (
                                ...
                                <button onClick={() => {
                                    trackQuoteStartedOnce()
                                    setIsAddingItem(true)
                                }} className="text-sm text-anchor-gold font-bold hover:underline">Browse Menu Options</button>
                            </div>
                        )}
                        ...
                        {selectedPackages.map(selection => {
                            ...
                            return (
                                <div key={selection.id} className={cn(
                                    'bg-anchor-bg-raised border border-anchor-gold/15 hover:border-anchor-gold/40 transition-all group',
                                    compact ? 'flex items-center justify-between p-2.5 gap-2' : 'flex flex-col md:flex-row md:items-center justify-between p-5'
                                )}>
                                    {compact ? (
                                        <>
                                            <div className="min-w-0 flex-1">
                                                <span className="text-sm font-bold text-anchor-cream-text group-hover:text-anchor-gold-vivid transition-colors truncate block">{pkg.name}</span>
                                                <span className="text-xs text-anchor-gold">{formatPrice(pkg.cost_per_head)}</span>
                                            </div>
                                            <div className="flex items-center gap-2 flex-shrink-0">
                                                <input
                                                    ...
                                                    className="w-14 h-8 px-1 text-center text-sm font-bold text-anchor-cream-text bg-anchor-bg-card border border-anchor-gold/30 outline-none focus:ring-1 focus:ring-anchor-gold"
                                                />
                    ...
                    {isAddingItem && (
                        <div className="fixed inset-0 bg-anchor-charcoal/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 min-h-screen" onClick={() => setIsAddingItem(false)}>
                            <div className="card-dark rounded-none shadow-2xl w-full max-w-xl max-h-[85vh] flex flex-col animate-fade-up" onClick={e => e.stopPropagation()}>
                                <div className="px-4 py-3 border-b border-anchor-gold/15 flex justify-between items-center bg-anchor-bg-raised rounded-t-none z-20">
                                    <div>
                                        <h3 className="font-serif font-bold text-lg text-anchor-cream-text">Add to your Package</h3>
                                        <p className="text-xs text-anchor-cream-text/55">Select food and drink options to add to your estimate.</p>
                                    </div>
                                    <button onClick={() => setIsAddingItem(false)} className="w-8 h-8 rounded-full bg-anchor-bg-card flex items-center justify-center text-anchor-cream-text/55 hover:text-anchor-cream-text hover:bg-anchor-bg-raised transition-all">
                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                        </svg>
                                    </button>
                                                    ...
                                                    <div className="grid grid-cols-1 gap-3">
                                                        {foodPackages.map(pkg => (
                                                            <button
                                                                ...
                                                                className="w-full text-left p-3 hover:bg-anchor-bg-raised transition-all border border-transparent hover:border-anchor-gold/20 flex min-w-0 justify-between items-start gap-3 group relative overflow-hidden sm:items-center"
                                                            >
                                                                <div className="relative z-10 min-w-0">
                                                                    <div className="break-words font-bold text-sm text-anchor-cream-text group-hover:text-anchor-gold-vivid">{pkg.name}</div>
                                                                ...
                                                                <div className="relative z-10 flex shrink-0 flex-col items-end">
                                                                    <div className="text-anchor-gold-vivid font-bold text-sm whitespace-nowrap bg-anchor-bg-raised px-2.5 py-0.5 group-hover:bg-anchor-bg-card transition-colors">
                                                    ...
                                                    <div className="grid grid-cols-1 gap-3">
                                                        {drinkPackages.map(pkg => (
                                                            <button
                                                                key={pkg.id}
                                                                onClick={() => addPackage(pkg.id)}
                                                                className="w-full text-left p-3 hover:bg-anchor-bg-raised transition-all border border-transparent hover:border-anchor-gold/20 flex min-w-0 justify-between items-start gap-3 group sm:items-center"
                                                            >
                                                                <div className="min-w-0">
                                                                    <div className="break-words font-bold text-sm text-anchor-cream-text group-hover:text-anchor-gold-vivid">{pkg.name}</div>
                                                                    {pkg.guest_description && <div className="text-xs text-anchor-cream-text/55 mt-0.5">{pkg.guest_description}</div>}
                                                                </div>
                                                                <div className="shrink-0 text-anchor-gold-vivid font-bold text-sm whitespace-nowrap bg-anchor-bg-raised px-2.5 py-0.5">
                                                                    {formatPrice(pkg.cost_per_head)}
                                                                </div>
                                                            </button>
                                                        ))}
                ...
                {config.vendors.length > 0 && (
                    <section>
                        <div className={cn('flex items-center gap-2', compact ? 'mb-3' : 'mb-6')}>
                            <span className={cn(compact ? 'w-5 h-5 text-[10px]' : 'w-7 h-7 text-xs', 'flex items-center justify-center border border-anchor-gold/50 text-anchor-gold-vivid font-bold')}>6</span>
                            <h4 className={cn(compact ? 'text-sm' : 'font-serif text-xl', 'font-bold text-anchor-cream-text')}>Recommended Services</h4>
                        </div>
                        <div className={cn('grid gap-2', compact ? 'grid-cols-1' : 'grid-cols-1 sm:grid-cols-2 gap-4')}>
                            {config.vendors.map(vendor => (
                                <label key={vendor.id} className={cn(
                                    ...
                                    selectedVendorIds.has(vendor.id) ? 'border-anchor-gold-vivid bg-anchor-gold-vivid/8' : 'border-anchor-gold/20 hover:border-anchor-gold/40 bg-anchor-bg-raised'
                                )}>
                                    <div className="relative flex items-center flex-shrink-0">
                                        <input
                                            ...
                                            className={cn(compact ? 'h-4 w-4' : 'h-5 w-5', 'rounded-none border-anchor-gold/30 focus:ring-anchor-gold accent-[#c9a020]')}
                                        />
                                    </div>
                                    <div className={cn(compact ? 'ml-2' : 'ml-4')}>
                                        <span className={cn(
                                            ...
                                            selectedVendorIds.has(vendor.id) ? 'text-anchor-gold-vivid' : 'text-anchor-cream-text'
                                        )}>{vendor.name}</span>
            ...
            {/* Footer Total */}
            <div className={cn(
                'bg-anchor-bg border-t border-anchor-gold/25',
                compact
                ...
                <div className={cn(compact ? '' : 'flex flex-col items-center md:items-start w-full md:w-auto')}>
                    ...
                    <span className={cn(
                        'font-serif font-bold text-anchor-cream-text tracking-tight',
                ...
                <button
                    ...
                    className={cn(
                        'group flex items-center justify-center gap-2 bg-anchor-gold-vivid hover:bg-anchor-gold text-anchor-bg font-bold rounded-none transition-all',
                        compact
