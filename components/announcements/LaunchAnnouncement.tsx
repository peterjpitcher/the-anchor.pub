...
const VARIANT_CLASSES: Record<LaunchAnnouncementVariant, string> = {
  hero: 'mt-4 rounded-md bg-anchor-gold/15 px-6 py-3 text-base font-semibold text-accent-text text-center',
  banner: 'rounded-md bg-anchor-gold/10 px-4 py-2 text-sm text-ink text-center',
  slim: 'border-t border-line-gold px-3 py-1.5 text-xs text-ink-muted text-center',
}
