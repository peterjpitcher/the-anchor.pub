    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-line px-5 py-4">
          <h2 className="text-base font-semibold text-ink-strong">Dietary Filters</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-6">
          {/* Dietary toggles */}
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-accent-text mb-3">Diet</p>
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-accent-text mb-3">Hide items containing</p>
            <div className="space-y-2">
