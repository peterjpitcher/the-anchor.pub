...
export function WizardStep6Confirm({ 
  ...
  const depositAmount = bookingData.menuSummary?.totals.deposit ?? (isSundayLunch ? computeLargeGroupDepositAmount(bookingData.partySize) : 0)
	          ...
	          <div className="flex gap-3">
	            ...
	            <div>
	              ...
	              <p className="text-sm text-amber-700">
	                £{LARGE_GROUP_DEPOSIT_PER_PERSON_GBP} per person deposit for Sunday roasts. This amount will be deducted from your final bill.
