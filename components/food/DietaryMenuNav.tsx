  ...
  return (
    <div className="flex flex-wrap justify-center gap-3 mb-6">
              ...
              isActive
                ? badgeColor === 'green'
                  ...
                  : badge
                    ...
                    : 'bg-anchor-gold-dark/20 border border-anchor-gold-dark text-anchor-gold-dark'
                : badgeColor === 'green'
                  ...
                  : badge
                    ...
                    : 'bg-anchor-gold-dark/10 border border-anchor-gold-dark/30 text-anchor-gold-dark hover:bg-anchor-gold-dark/20'
            )}
      ...
      <a
        ...
        download
        className="inline-flex items-center gap-2 px-4 py-2 bg-anchor-gold-dark/10 border border-anchor-gold-dark/30 rounded-lg text-anchor-gold-dark hover:bg-anchor-gold-dark/20 transition-colors text-sm font-medium"
      >
