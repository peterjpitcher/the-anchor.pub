...
describe('Breadcrumb', () => {
  ...
  it('marks last item as current by default', () => {
    ...
    expect(electronics).toHaveClass('text-ink-strong', 'font-semibold')
  })
...
describe('Breadcrumb composition API', () => {
  ...
  it('BreadcrumbLink renders as Next Link', () => {
    ...
    expect(link).toHaveClass('text-ink-muted', 'hover:text-accent-text')
  })
  ...
  it('BreadcrumbPage has current page styling', () => {
    ...
    expect(page).toHaveClass('text-ink-strong', 'font-semibold')
  })
