...
describe('Breadcrumb', () => {
  ...
  it('marks last item as current by default', () => {
    ...
    expect(electronics).toHaveClass('text-anchor-gold-bright', 'font-semibold')
  })
...
describe('Breadcrumb composition API', () => {
  ...
  it('BreadcrumbLink renders as Next Link', () => {
    ...
    expect(link).toHaveClass('text-anchor-cream-text/60', 'hover:text-anchor-gold-dark')
  })
  ...
  it('BreadcrumbPage has current page styling', () => {
    ...
    expect(page).toHaveClass('text-anchor-gold-bright', 'font-semibold')
  })
