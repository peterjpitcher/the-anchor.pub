...
const popoverVariants = cva(
  'absolute z-50 rounded-none bg-anchor-green-card shadow-lg border border-anchor-gold-dark/15 outline-none',
  {
    variants: {
      size: {
        sm: 'max-w-sm',
  ...
  ({ 
    ...
    const getArrowStyles = () => {
      ...
      switch (actualPlacement) {
        ...
        case 'top-end':
          return {
            className: `${baseStyles} border-t-8 border-x-4 border-b-0 border-t-anchor-green-card border-x-transparent`,
        ...
        case 'bottom-end':
          return {
            className: `${baseStyles} border-b-8 border-x-4 border-t-0 border-b-anchor-green-card border-x-transparent`,
        ...
        case 'left-end':
          return {
            className: `${baseStyles} border-l-8 border-y-4 border-r-0 border-l-anchor-green-card border-y-transparent`,
        ...
        case 'right-end':
          return {
            className: `${baseStyles} border-r-8 border-y-4 border-l-0 border-r-anchor-green-card border-y-transparent`,
...
export const PopoverHeader = forwardRef<HTMLDivElement, PopoverHeaderProps>(
  ({ className, children, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('px-4 py-3 border-b border-anchor-gold-dark/15', className)}
      {...props}
    >
      {children}
    </div>
...
export const PopoverFooter = forwardRef<HTMLDivElement, PopoverFooterProps>(
  ({ className, children, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('px-4 py-3 border-t border-anchor-gold-dark/15', className)}
      {...props}
    >
      {children}
    </div>
