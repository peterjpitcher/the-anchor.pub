...
1. **Book ahead.** The best pubs fill up, particularly in good weather. A week in advance is safe; same-day is risky at popular places.

2. **Arrive hungry.** Surrey pub portions tend to be generous. If you're having a starter, you might want to skip the bread basket.

3. **Ask about the meat.** Is it cooked to order or carved from a joint? Neither is wrong, but it's worth knowing what you're getting.

4. **Check the vegetarian option.** A pub that puts effort into the veggie roast usually puts effort into everything else too. A nut roast from a packet tells you something about the kitchen.
