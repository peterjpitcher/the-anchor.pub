...
keywords:
  ...
  - christmas booking in heathrow airport
  - christmas party planning checklist
  - group christmas meal near heathrow
  - work christmas party organiser
...
Group Christmas meals rarely go wrong because someone picked the wrong venue. They go wrong because the decisions got made in the wrong order. A poll goes round, twelve people vote, four turn out to be from another team, and by the time anyone tries to book, the good dates have gone and nobody has paid a penny.

So here is the order we would use, from watching organisers do this every November and December. It works whichever venue you choose. Where a rule is ours specifically, we have said so.

## Start with headcount, not the date
...
## Agree the format before you collect a penny

Here is the bit most checklists skip. On our Christmas menu, guests pick 1, 2 or 3 courses **individually**. The table does not commit as one. Your finance manager can have three courses and the colleague saving for a house can have one, same table, same booking. That flexibility has a consequence:

| Courses | Pre-book | Pre-order |
|---|---|---|
| 1 course | Required | Not required |
| 2 courses | Required | Required |
...
1. Put the date, the number and the deposit amount in one message, with your own bank details or payment link in that same message. Not a follow-up. You are collecting from your colleagues, then paying the venue as one deposit.
2. Set a deadline before the booking date, and say plainly that the booking goes in with whoever has paid.
...
This belongs at the top of the list rather than the bottom, and we have put it last because most people only realise it once they have read the rest. A Christmas do near the airport is really two different products, and organisers routinely book one while picturing the other. A hotel party night is a shared ballroom with entertainment laid on. A sit-down Christmas dinner is your own table, your own group, and no disco. We are the second one, deliberately.

Neither is better. But the checklist above only works for the second, because a party night is a ticket you buy rather than a booking you build. If you are not certain which your group wants, settle that first: [Christmas dinner or party night](/blog/christmas-dinner-or-party-night-which-suits-your-group) goes through it honestly, including where we tell you to book a hotel instead.

If the sit-down version is what your group wants, that is [Christmas at The Anchor](/christmas-parties). For work bookings, our [corporate events page](/corporate-events) covers the wider options, and [work Christmas party ideas near Heathrow](/blog/work-christmas-party-ideas-near-heathrow) deals with the office-specific traps.

## FAQs

### How far in advance should I book a group Christmas meal?

As soon as you have a confident headcount. The hard floor with us is 24 hours' notice, but that is a minimum, not a plan. December dates go early everywhere, and groups over 20 or wanting a buffet need the extra lead time.
...
They can order the adult two or three course tier, charged at the adult price. There is no kids two-course or three-course option and no child price for those tiers. There is a kids version of the one-course option.
