...
## 3. CELEBRATE THE SEASON SECTION

**Heading:** Make it the **staff Christmas party** they actually talk about
...
**Heading:** Why your office should book their **corporate Christmas party** here

**Card 1, Location:**
> **7 Minutes from Heathrow Terminal 5**
> The closest proper pub to Heathrow Airport. Two minutes from M25 Junction 14, fifteen minutes from Terminal 2. Colleagues flying in from other offices? They'll be at the bar before their taxi receipt loads. If you're searching for a **christmas party near me**, we're the easy answer for anyone west of London.

**Card 2, No Parking Stress:**
> **Free Parking, Outside the ULEZ**
> Around 20 free spaces on-site, no meters, no charges, no £12.50 ULEZ fee. Your team can leave cars overnight and collect them the next morning. That alone makes us one of the most affordable **christmas party venues** near Heathrow.

**Card 3, Real Pub, Real Christmas:**
> **A Proper Village Pub, Not a Hotel Function Room**
> No fluorescent lighting. No identikit conference suites. A genuine village local in Stanwell Moor, Surrey (TW19 6AQ) with warm hospitality, crackers on the table and food that actually tastes of Christmas. This is what your **company christmas party venue** should feel like.

**Alert box:**
> **Early bird offer:** Book by 1 October and take 20% off your food bill, for every adult in parties of six or more. That's a decent saving to report back to finance.

---

## 5. FOR THE ORGANISER SECTION

**Heading:** For the organiser: we've thought of everything

**Perk 1, Simple Admin:**
> **No Spreadsheet Required**
> We send you a pre-order form link. Share it with the team. Everyone picks their courses. Done. Dietary requirements, allergies and children's meals all captured in one place. VAT invoices are available for accounts, just ask.
...
## 6. CHRISTMAS PARTY PACKAGES & PRICING

**Heading:** **Christmas party packages** & pricing for office groups

**Intro:**
> Transparent per-person pricing, no hidden hire fees, and flexible formats to suit your team size. Pick a setup, send your enquiry, and we'll hold your date.
...
> **Exclusive use of the entire pub**
> Pricing on enquiry
...
## 7. FESTIVE MENU SNAPSHOT

**Badge:** Three-course set menu

**Heading:** Our **festive menu**, the same at lunch and dinner
...
**Highlight box:**
> Looking for a **christmas lunch near me** that's actually worth the trip? Our midweek lunches are the same full festive menu as the evening, no cut-down "lunch version." Three courses, all the trimmings, proper coffee to finish.
...
**FAQ 5: How close are you to Heathrow and the M25?**
> The Anchor is in Stanwell Moor, Surrey (TW19 6AQ), seven minutes from Heathrow Terminal 5, fifteen minutes from Terminal 2, and two minutes from M25 Junction 14. We're a **christmas party venue** that colleagues from different offices, terminals and even countries can reach easily. If your team has been searching for a **christmas party near me** near Heathrow, this is the one.

**FAQ 6: Is there parking? Are you inside the ULEZ?**
> Around 20 free spaces on-site, no meters, no charges. We're outside the ULEZ zone, saving your guests £12.50 per car compared to driving into London. Cars can stay overnight. We're one of the most accessible **company christmas party venues** near Heathrow.

**FAQ 7: What entertainment do you offer for a works christmas do?**
...
**Heading:** Ready to book your **office christmas party**?

**Copy:**
> Send your enquiry and we'll come back within one working day with availability, pricing and everything you need to get sign-off. Prefer a quick chat? Call the team, we'll talk you through the options.

> The sooner you get in touch, the better your date options. Friday and Saturday nights sell out by October. Midweek slots follow shortly after.
...
| Keyword | Vol/mo | Priority | Sections present |
|---------|--------|----------|-----------------|
| office christmas party | 5,000 | PRIMARY | Title, meta, H1, FAQ 8, Final CTA heading, Final CTA |
| corporate christmas party | 500 | PRIMARY | H1, Why Book heading, Package 3, OG title |
| staff christmas party | 500 | H2, body | Celebrate heading, Organiser Perk 3, FAQ 4, Package mentions |
| works christmas do | 500 | Body, FAQs | Hero description, Package 2, FAQ 7, Celebrate section |
| work christmas lunch | 50 | FAQs, body | Celebrate section, Package 1, FAQ 2 |
| company christmas party venue | 50 | Location | Why Book Card 3, FAQ 6 |
| christmas party booking | 500 | CTA sections | Hero CTA, FAQ 1, Package CTA, Final CTA |
| christmas party venue | 500 | Location | Why Book Card 2, FAQ 5 |
| christmas party packages | 500 | Pricing | Section 6 heading, FAQ 3 |
| festive menu | 500 | Menu | Hero description, Menu section, Early bird box, FAQ 2, FAQ 3 |
| festive lunch | 500 | Menu/timing | Menu section, FAQ 2 |
| christmas party near me | 5,000 | Location | Why Book Card 1, FAQ 5 |
| christmas lunch near me | 50,000 | Menu, FAQs | Menu highlight box, FAQ 2 |

**All 13 target keywords confirmed present. No keyword exceeds natural density.**

---

## NOTES FOR DEVELOPER

1. **All CTAs** should link to the Christmas enquiry form (not /contact or /food-menu as currently implemented)
2. **Early bird date** is "1 October", not "October 31st" as the current page states
3. **Deposit** is described as "non-refundable" throughout, matching the main christmas parties page
4. **Phone number** 01753 682707 and **email** manager@the-anchor.pub should be clickable (tel: and mailto: links)
5. This page should **canonically stand alone**, it is not a duplicate of /christmas-parties but a focused landing page for corporate/office search intent
6. Consider adding LocalBusiness and Event structured data (JSON-LD) for rich snippets
