...
export const nationsEditorial = {
  ...
  hours: 'Our usual opening and closing times apply. When a match kicks off before we open, viewing starts at opening and you will miss the start. When a match runs beyond closing, viewing ends when the pub closes and you may miss the finish. Each game makes this clear before you book.',
...
export const nationsFaqs = [
  ...
  { question: 'What if the match finishes after the pub closes?', answer: 'We keep our existing closing time. Viewing ends when the pub closes, even if the match is still being played. The fixture card flags this before you book.' },
