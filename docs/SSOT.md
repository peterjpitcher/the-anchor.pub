...
- Heated beer garden *(verified NO, owner-confirmed 10 September 2026: no heaters or heated areas in the garden)*
...
- **Not heated.** There are no heaters or heated areas in the garden (owner-confirmed 10 September 2026). Never describe the garden, or any seating in it, as heated (§14). Indoor heating is true and fine to mention.
...
- **Heated beer garden**, verified **NO** (owner-confirmed 10 September 2026). The garden has no heaters. Never write "heated areas", "heated spots", patio heaters or "heated in winter" about the garden or any seating in it. The heating is indoors, and saying so is fine.
...
- **10 September 2026.** The beer garden is not heated (owner-confirmed). §9 had listed "heated areas" as a garden feature, and from there the claim had reached the `/beer-garden` search description, the `/drinks` page and eight blog posts. Two older posts also gave the smoking area heating, and one listed "entertainment in heated areas". All removed or reworded, and `tests/ssot-drift-guard.test.ts` now fails if a heated-garden claim comes back.
