...
| /food-menu | default | breadcrumbs=[{ name: 'Food & Drink' }]<br/>tags=[ { label: '🍖 Roast pre-orders', variant: 'default' }, { label: '🍕 Stone-baked pizzas', variant: 'default' }, { label: '🍺 Pub classics', variant: 'default' }, { label: '🌱 Veggie friendly', variant: 'default' } ] | primary slot, secondary slot, info slot |
