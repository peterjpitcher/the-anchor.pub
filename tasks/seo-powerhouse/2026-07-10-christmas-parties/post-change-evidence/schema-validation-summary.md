...
- Validated at (UTC): 2026-07-10T09:31:39.711885+00:00
- Pages with JSON-LD: 1
- Typed JSON-LD blocks checked: 93
...
| Blocks missing a RECOMMENDED field | 11 |
| Retired/deprecated rich results (HowTo/FAQ) | 1 |
| Self-serving Review/AggregateRating | 0 |
| Rich-result eligible (required complete, live type) | 3 |
| Unknown @type (no verdict given) | 79 |
