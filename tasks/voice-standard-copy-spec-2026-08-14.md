...
> **SUPERSEDED, a record only. Added 11 September 2026.** The voice this spec rolled out was replaced by `docs/SSOT.md` §1, version 2.0, which the owner confirmed on 11 September 2026. Where this spec differs ("cheeky" copy, "guests" for the reader, one exclamation mark per section, replacement lines without contractions), §1 wins. Do not paste copy from here without checking it against §1 and §14.
