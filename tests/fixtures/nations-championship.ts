...
export function nationsFixture(overrides: Partial<ScreeningFixture> = {}): ScreeningFixture {
  return {
    ...
    matchState: 'scheduled', screeningDecision: 'confirmed', broadcastDecision: 'confirmed', linearChannel: 'ITV1', screenLabel: 'Main screen', commentary: 'on', coverage: 'from_opening',
